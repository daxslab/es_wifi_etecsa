...
class CheckPortal extends AsyncTask<String, Void, Boolean> {
    ...
    protected Boolean doInBackground(String... params) {
        ...
        try {
            ...
            NotificationUtils.createNotification(this.mContext, this.mContext.getString(R.string.app_name), this.mContext.getString(R.string.app_name), WifiActions.SSL_WARNING_NOTIFICATION_ID, mContext.getString(R.string.ssl_warning), mContext.getString(R.string.not_valid_ssl), "#alert-2");
            this.isWifiOk = false;
        }catch (Exception ex){
            NotificationUtils.createNotification(this.mContext, this.mContext.getString(R.string.app_name), this.mContext.getString(R.string.app_name), WifiActions.CANT_VERIFY_SSL_WARNING_NOTIFICATION_ID, mContext.getString(R.string.cant_verify_ssl_warning), mContext.getString(R.string.cant_verify_ssl), "#alert-4");
            this.isWifiOk = false;
        }
